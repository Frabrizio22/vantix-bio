...
// 5. Update API_SECRET_KEY below with a secure random key
// ============================================
...
const API_SECRET_KEY = 'vantix_live_2026_secure_key_abc123'; // ⚠️ CHANGE THIS!
...
function sendCustomerConfirmation(data) {
  ...
  try {
    ...
    // Send Telegram alert about email failure
...
// ============================================
// SHEET FORMATTING (RUN ONCE AFTER SETUP)
// ============================================
function formatVantixSheets() {
  const ss = SpreadsheetApp.getActiveSpreadsheet();
  
  // Format Catalog sheet with new category validation
  formatCatalogSheet(ss);
  
  Logger.log('✅ Sheet formatting complete!');
}

function formatCatalogSheet(ss) {
  ...
  // ✅ NEW: Category dropdown with FDA-compliant categories
  ...
  Logger.log('✅ Catalog sheet formatted with new categories');
}
